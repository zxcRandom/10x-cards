...
import { HttpStatus, ErrorCode, type DeckDTO, type ErrorResponse } from "@/types";
...
describe("DeckService.getDeckById", () => {
  ...
  it("should throw error if database query fails", async () => {
    ...
    await expect(service.getDeckById("user-123", "deck-123")).rejects.toThrow("Failed to get deck");
  });
});
```
