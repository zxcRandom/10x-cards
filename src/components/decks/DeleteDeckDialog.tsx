...
export default function DeleteDeckDialog({ open, deck, onOpenChange, onSuccess }: DeleteDeckDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Ta akcja jest nieodwracalna i spowoduje usunięcie talii oraz wszystkich fiszek w niej zawartych.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit}>
          <div className="space-y-4 py-4">
            ...
            <div className="flex items-start gap-2">
              ...
              <Label htmlFor="understood" className="cursor-pointer text-sm">
                Rozumiem konsekwencje i chcę trwale usunąć tę talię wraz ze wszystkimi fiszkami
              </Label>
            </div>
          ...
          <DialogFooter>
            ...
            <Button type="submit" variant="destructive" disabled={loading || !understood}>
