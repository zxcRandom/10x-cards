...
/**
 * Creates a Supabase client for server-side rendering with cookie support
 ...
 */
export function createServerClient(cookies: AstroCookies, cookieHeader?: string | null): SupabaseClient<Database> {
